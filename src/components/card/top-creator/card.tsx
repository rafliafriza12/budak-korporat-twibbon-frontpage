...
const CardComponentTopCreator: React.FC<CardConfigProps> = ({ data }) => {
  ...
  return (
    <main
      className={`flex border-2 w-[80vw] h-[45vh] lg:h-auto lg:w-[35vh] bg-card flex-col items-center gap-[9vh] lg:gap-[5vh] p-5`}
    >
      <div className="bg-[#D9D9D9] w-[100%] h-[20vh] relative z-0 p-5 flex justify-center">
        <div className="bg-[#D9D9D9]  w-20 h-20 scale-1.5 border-2  absolute top-36 rounded-full border-black"></div>
      </div>
